...
const ShareImage = forwardRef(function ShareImage({ data, tt }, ref) {
  ...
  const CAP_H = PAD * 2 + labelH + schedH;
      ...
      <div style={{ position: 'absolute', top: PAD + 'px', left: PAD + 'px', width: contentW + 'px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', height: headH + 'px' }}>
            <div style={{ width: timeColW + 'px', boxSizing: 'border-box', background: '#ececec', borderRight: '1px solid #fff' }} />
            {days.map((d, i) => (
              <div key={d} style={{
          ...
          <div style={{ display: 'flex', height: bodyH + 'px' }}>
            <div style={{ width: timeColW + 'px', boxSizing: 'border-box', position: 'relative', background: '#ececec', borderRight: '1px solid #fff' }}>
              {hours.map((h, i) => {
              ...
              <div key={d} style={{
                ...
                {hours.slice(1, hourCount).map((h, j) => (
                  <div key={'l' + h} style={{
                    ...
                    top: (((j + 1) / hourCount) * bodyH) + 'px', height: '1px', background: '#eee',
                  }} />
                ))}
                {tt.blocks.filter(b => b.day === d).map(b => {
                  ...
                  const blkStyle = {
                    ...
                    boxSizing: 'border-box', background: '#fff', border: '1px solid #bbb',
